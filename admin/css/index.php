			...
			<div class="pics">
				<?php
					...
					for ($i = 0; $i < sizeof($directories); $i++) {
						...
						$directories[$i] = str_replace('_', ' ', $directories[$i]);
					    if($directories[$i] != 'css' && $directories[$i] != 'images' && $directories[$i] != 'js'){
							echo '<a href="' . $link . '/"><div class="pic"><img src="' . $link . '/' . $link .'.jpg" alt="Aashna Kunkolienker" class="img-responsive"><div class="bar"><h2>' . $directories[$i] . '</h2></div></div></a>';
						}
					}
				?>
			</div>
